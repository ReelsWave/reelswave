    ...
    return (
        <StyledWrapper className={className} onClick={onClick}>
            <div style={{ position: 'relative' }}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="100%" width="100%" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 0, pointerEvents: 'none' }}>
                    <defs>
                        <pattern patternUnits="userSpaceOnUse" height={30} width={30} id="dottedGrid">
                            <circle fill="rgba(0,0,0,0.15)" r={1} cy={2} cx={2} />
                        </pattern>
                    </defs>
                    <rect fill="url(#dottedGrid)" height="100%" width="100%" style={{ pointerEvents: 'none' }} />
                </svg>
            </div>
        </StyledWrapper>
    );
...
const StyledWrapper = styled.div`
  ...
  button span {
    ...
    font-weight: 500;
    font-size: 1em;
    color: rgba(255, 255, 255, 1); /* Changed from dark to white for dark mode */
